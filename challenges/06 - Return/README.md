The goal of this challenge is to remove the high security label from `h` and write the result to `l`. In each run `h` will be set to a random boolean. The solution will be tested several times.
